...
import 'package:grocery2/feature/login/presentation/cubit/login_cubit.dart';
import 'package:grocery2/feature/login/presentation/cubit/login_state.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => AuthCubit(
          AuthRepoImpl(preferenceManager: PreferenceManager()), // تمرير الـ Repo للـ Cubit
        ),
