...
import 'package:grocery2/features/product_details/presentation/screens/product_details_screen.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) {
              return ProductDetailsScreen(productId: int.parse(meal.mealId));
            },
          ),
        );
      },
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () =>
                        context.read<ProductListCubit>().addToCart(meal),
